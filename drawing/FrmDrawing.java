...
public class FrmDrawing extends JFrame {
	...
	public FrmDrawing() {
		...
		tglbtnSelect.setBackground(new Color(204, 204, 204));

		setTitle("Ljiljana Djuric IT48-2020");
		...
		pnlNorth.setBackground(new Color(255, 160, 122));
	    ...
	    btnGroup.add(rdbtnRectangle);
				...
				btnModify.setBackground(new Color(51, 204, 255));
