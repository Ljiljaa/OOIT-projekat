...
public class FrmStack extends JFrame {
	 ...
	 */
	public FrmStack() {
		setTitle("Anja Janjusevic IT/72 2019");
		...
		panelCenter.setBackground(new Color(255, 204, 51));
		...
		btnAdd.setBackground(new Color(210, 170, 109));
		...
		btnDelete.setBackground(new Color(210, 170, 109));
